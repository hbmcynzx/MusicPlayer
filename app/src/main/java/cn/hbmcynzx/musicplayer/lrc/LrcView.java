package cn.hbmcynzx.musicplayer.lrc;
...
public class LrcView extends android.widget.TextView {
	...
	private float textHeight = 90; // 文本高度
	...
	protected void onDraw(Canvas canvas) {
		...
		currentPaint.setColor(Color.argb(210, 255, 0, 255));
		notCurrentPaint.setColor(Color.argb(140, 255, 255, 0));
